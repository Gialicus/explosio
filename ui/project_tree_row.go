...
// CreateTreeNodeTemplate crea il template di riga per l'albero (icona + label).
...
// UpdateTreeNodeRow aggiorna il template di riga con icona e testo (nome attività o risorsa).
